...
cf ssh -N -L 63307:$ip_address:3306 pal-tracker &
cf_ssh_pid=$!

echo "Waiting for tunnel"
sleep 5

flyway-*/flyway -url="jdbc:mysql://127.0.0.1:63307/$db_name" -locations=filesystem:$2/databases/tracker -user=$db_username -password=$db_password migrate
